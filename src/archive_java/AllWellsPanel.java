...
public class AllWellsPanel extends JPanel {
  ...
  private String project_sys_name;
    ...
    public AllWellsPanel(DatabaseManager _dbm, CustomTable _table, String _project_sys_name) {
    ...
    FilterPanel fp = new FilterPanel(dbm, table, Integer.parseInt(project_sys_name.substring(4)) ,DialogMainFrame.ALLWELLS );
